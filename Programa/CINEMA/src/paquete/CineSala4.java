...
public class CineSala4 extends JFrame implements ActionListener {
    ...
    String Fecha = "", Hora = "", Pelicula = "", IDPelicula = "", Usuario = "", Idioma = "", Duracion = "", Clasificacion = "", Sala = "4";
    ...
    OracleResultSet rs = null;
     ...
     public CineSala4(String User, int IDUser, String peli, String ID, int SillasReserva, String fecha, String horario) {
        super("UCCine - Asignación de Asientos (4)");
        Usuario = User;
        IDUsuario = IDUser;
        Pelicula = peli;
        IDPelicula = ID;
