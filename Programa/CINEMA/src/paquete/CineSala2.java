...
public class CineSala2 extends JFrame implements ActionListener {
    ...
    String Fecha = "", Hora = "", Pelicula = "", IDPelicula = "", Usuario = "", Idioma = "", Duracion = "", Clasificacion = "", Sala = "2";
    ...
    public CineSala2(String User, int IDUser, String peli, String ID, int SillasReserva, String fecha, String horario) {
        super("UCCine - Asignación de Asientos (2)");
        Usuario = User;
        IDUsuario = IDUser;
        Pelicula = peli;
        IDPelicula = ID;
