...
public class CineSala1 extends JFrame implements ActionListener {
    ...
    String Fecha = "", Hora = "", Pelicula = "", IDPelicula = "", Usuario = "", Idioma = "", Duracion = "", Clasificacion = "", Sala = "1";
    ...
    public CineSala1(String User, int IDUser, String peli, String ID, int SillasReserva, String fecha, String horario) {
        super("UCCine - Asignación de Asientos (1)");
        Usuario = User;
        IDUsuario = IDUser;
        Pelicula = peli;
        IDPelicula = ID;
